...
class SaleCommissionMakeSettle(models.TransientModel):
    _name = "sale.ds.commission.make.settle"
    ...
    def _get_settlement(self, agent, company, sett_from, sett_to):
        return self.env['sale.ds.commission.settlement'].search([
            ('agent', '=', agent.id),
            ('date_from', '=', sett_from),
            ('date_to', '=', sett_to),
    ...
    def action_settle(self):
            ...
            for company in agent_lines.mapped('company_id'):
                ...
                while pos < len(agent_lines_company):
                    ...
                    if line._skip_settlement():
                        continue
                    order_date = line.order_date.date()
                    if order_date > sett_to:
        ...
        if len(settlement_ids):
            return {
                ...
                'res_model': 'sale.ds.commission.settlement',
