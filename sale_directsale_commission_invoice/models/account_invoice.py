...
class AccountInvoiceLine(models.Model):
    ...
    directsale_sale_order_line_id = fields.Many2one('sale.order.line', string="Origin Sale Item", index=True) # TODO: Voltar para sale_line_id (aparentemente é padrão do módulo Invoice ou Sale
